...
<html class="no-js">
	...
	// !!!!ACHTUNG: Detailiertere Kommentare für den Header in adminpage.php!!!!
	echo '		
...
';
	...
	';
	/* Erste-/Überschrift-Sektion */; echo '
	...
	';
	/* Zweite-/Inhalt-/FAQ-Sektion
	 * Überschrift gefolgt von einer liste:
	 * span mit der Klasse "number" für Boxen in denen die aktuelle Fragenummer steht
	 * danach die aktuelle Frage als <h4> Überschrift und der Antwort in einem Absatz <p> -> nächstes Listen Item*/;echo '
