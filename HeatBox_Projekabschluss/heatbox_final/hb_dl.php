...
';
    ...
    <header class="navbar navbar-fixed-top">
		...
		if (isset($_SESSION['user'])) {
			echo '<li class="active"><a href="hb_dl.php">' . $text["text"] . '</a></li>';
    ...
    <!-- /header -->';
		...
		<!-- 3 Spaltige Tabelle (Version|Beschreibung mit Links|ChangeLog)-->
		<!-- ChangeLog als "Pop Up" -> data-toggle: Modal -->
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<br>
									Die Compact beim Update mit zusätzlicher Spannungsquelle (Akku, Netzteil) versorgen!</td>
									<td><a data-toggle="modal" href="#log6">ChangeLog(1)</a>
									<br>
									<a data-toggle="modal" href="#log66">ChangeLog(2)</a></td>
								</tr>
								<tr>
									<td>V1.5.1</td>
	...
	<!-- "Pop Up"-Inhalt der ChangeLogs als Modal -->
		<!--  Changelog 1 -->
		...
		<div class="modal hide fade in" id="log6" aria-hidden="false">
			...
			<br />
			<p>
				<b> &nbsp; Die Heatbox 2.0 Software - Was ist neu: </b>
			</p>
			<ul>
				<li>
		...
		<div class="modal hide fade in" id="log11" aria-hidden="false">
			...
			<p>
				<b>Fehler bei zu großen Versorgungsakkus</b>
			</p>
			<br>
			<p>
