...
';
	...
	';
		...
		include "comment.class.php";
		 ...
		 //  Alle Kommentare in das $comments Array zur Ausgabe laden
		$comments = array();
	...
	';
		/* Überschrift + Informationsabsatz */;echo '
	...
	';
		/* Anzeigen der geschriebenen Kommentaren, Login zum Kommentieren/Kommentarfeld */;echo '
	<section id="recent-works">
		...
		// Kommentare nach und nach ausgeben
		...
		echo '' . $text["text"] . '</h3>
					<br>';
		// Wenn angemeldet, dann Kommentarfeld anzeigen und Button = Abschicken/Submit
		if (isset($_SESSION['user'])) {
			...
			// Wenn nicht, dann bitte anmelden + Login Button -> Modal fürs Login aufrufen
		} else {
			echo '<p>';
